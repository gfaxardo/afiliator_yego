    ...
    <div className="max-w-2xl mx-auto mt-20">
      <div className="bg-yellow-50 border border-yellow-300 rounded-lg p-8 text-center">
        ...
        <p className="text-sm text-yellow-700 mb-4">
          <strong>{name}</strong> ya no esta disponible como ruta principal.
          Usa el <strong>Centro Operativo</strong> para todas las operaciones.
        </p>
        ...
        <button
          onClick={() => navigate('/scout-liq/centro-operativo')}
