...
class UnifiedLoadPreviewLine(BaseModel):
    ...
    motivo_pago: str = ""
    cohorte_iso: str = ""
    operational_source_universe: str = ""
    source_confidence: str = ""
    payable_source_status: str = ""
    source_warning: str = ""
    status: str = "ok"
    errors: List[str] = []
    warnings: List[str] = []
...
class UnifiedLoadApplyDetail(BaseModel):
    ...
    observed_affiliation_created: Optional[bool] = None
    observed_affiliation_id: Optional[int] = None
    observed_affiliation_status: Optional[str] = None
    eligible_for_cutoff: Optional[bool] = None
    reconciliation_status: Optional[str] = None
    driver_operational_state: Optional[str] = None
    parity_status: Optional[str] = None
    parity_explanation: Optional[str] = None
    system_confidence_level: Optional[str] = None
    operational_readiness: Optional[str] = None
    next_action: Optional[str] = None
    driver_resolution_status: Optional[str] = None
    assignment_status: Optional[str] = None
    payment_history_status: Optional[str] = None
    applied_entities: Optional[str] = None
    skipped_entities: Optional[str] = None
    rejected_entities: Optional[str] = None
